...
const placeOrderCod = async (req, res) => {
  try {
    const result = await orderService.placeOrderCod(req.body);
    res.json(result);
  } catch (error) {
    console.log(error);
    res.json({ success: false, message: "Error" });
...
const userOrders = async (req, res) => {
  try {
    const result = await orderService.userOrders(req.body.userId);
    res.json(result);
  } catch (error) {
    console.log(error);
    res.json({ success: false, message: "Error" });
...
const updateStatus = async (req, res) => {
  console.log(req.body);
  try {
    const result = await orderService.updateStatus(req.body.orderId, req.body.status);
    res.json(result);
  } catch (error) {
    res.json({ success: false, message: "Error" });
  }
